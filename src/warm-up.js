...
var stockCount = 20;
if (stockCount >=1) {
  console.log(`I'm going to go eat some ${food}`);
} else {
...
var vegtables = ['cucumber', 'carrot', 'celery', 'potato', 'leek'];
...
var fruits = ['kiwi', 'orange', 'lemon', 'lime', 'strawberry', 'apple', 'blueberry'];
...
var groceryStore = {
  name: 'Alfalfas',
  isOpen: true,
  vegatables: ['carrot', 'leek', 'potatoes']
